...
if __name__ == "__main__":
    ...
    markers_output_dir = os.path.join(base_dir, "outputs/scores/markers")
    ...
    print("✓ Per-marker raw, weighted, and max scores saved to outputs/scores/markers/scored_markers_with_max.csv")
    ...
    print("✓ Marker pillar summary saved to outputs/scores/markers/marker_pillar_summary.csv")
    ...
    print(f"Raw marker scores exported to outputs/scores/markers/normalized_marker_scores.csv")
    ...
    print(f"✅ Raw marker values exported to outputs/scores/markers/raw_marker_values.csv")
