...
Extracted from preliminary_data/scripts/wellpath_score_runner_survey_v2.py
Contains all 327 survey questions with scoring logic and pillar weights
"""

# Import scoring functions from survey_scorer
# These will be available when the config is imported
from scoring_engine.survey_scorer import SurveyScorer

# Create static references to scoring functions for use in lambdas
scorer = SurveyScorer()
protein_intake_score = scorer.protein_intake_score
calorie_intake_score = scorer.calorie_intake_score
score_cognitive_activities = scorer.score_cognitive_activities
stress_score = scorer.stress_score
coping_score = scorer.coping_score
score_date_response = scorer.score_date_response

# Import constants needed by scoring functions
COPING_WEIGHTS_6_07 = SurveyScorer.COPING_WEIGHTS

# Screening guidelines (months) for Core Care preventive screenings
# These define how recent a screening should be to get full credit
screen_guidelines = {
    "10.01": 6,    # Dental exam - every 6 months
    "10.02": 12,   # Physical exam - annually
    "10.03": 24,   # Vision check - every 2 years
    "10.04": 24,   # Mammogram - every 2 years (varies by age/risk)
    "10.05": 12,   # Colonoscopy followup - varies (10 years for screening, using 12 for tracking)
    "10.06": 12,   # PSA test - annually for high risk
    "10.07": 12,   # Skin check - annually
    "10.08": 36,   # Pap smear - every 3 years
}
...
QUESTION_CONFIG = {
    ...
    "2.13": {
        "question": "How often do you consume processed meat (such as bacon, sausages, hot dogs, ham, salami, pepperoni, deli meats, or canned meats)?",
    ...
    "2.14": {
        "question": "Would you consider decreasing your processed meat consumption in support of your longevity goals?",
        "pillar_weights": {},
        "response_scores": {
            "Yes - open to trying": 0.8,
            "Yes - actively working on it": 1.0,
    ...
    "2.67": {
        "question": "How often do you consume red meat (such as beef, pork, lamb, veal, or goat)?",
        "pillar_weights": {"Nutrition": 4, "CoreCare": 3},
        "response_scores": {
            "Rarely or Never": 1.0,
            "Less than once a week": 1.0,
            "1-2 times per week": 0.8,
    ...
    "2.68": {
        "question": "Would you consider decreasing your red meat consumption in support of your longevity goals?",
        "pillar_weights": {},
        "response_scores": {
            "Yes - open to trying": 0.8,
            "Yes - actively working on it": 1.0,
    ...
    "2.20": {
        "question": "Would you consider increasing your daily fruit consumption in support of your longevity goals?",
        "pillar_weights": {},
        "response_scores": {
            "Yes - actively working on it": 1.0,
            "Yes - open to trying": 0.8,
    ...
    "2.65": {
        "question": "How many total servings of vegetables do you consume daily?",
        "pillar_weights": {"Nutrition": 6},
        "response_scores": {
            "0": 0.2,
            "1-2": 0.4,
    ...
    "2.66": {
        "question": "Would you consider increasing your daily vegetable consumption in support of your longevity goals?",
        "pillar_weights": {},
        "response_scores": {
            "Yes - actively working on it": 1.0,
            "Yes - open to trying": 0.8,
    ...
    "2.62": {
        "pillar_weights": {"Nutrition": 4},  # calorie intake scoring
    ...
    "4.28": {
        "question": "Have you ever been diagnosed with sleep apnea?",
        "pillar_weights": {"Sleep": 7, "CoreCare": 3},
        "response_scores": {
            "Yes": 1.0,  # Will be overridden by complex calculation
            "No": 1.0,
            "I suspect I may have it but haven't been diagnosed": 0.0,
        },
        "multi_select": False,
        "complex_calc": "sleep_apnea"
    },
    "4.29": {
        "question": "How long has it been since your sleep apnea diagnosis?",
        "pillar_weights": {},  # Used in complex calculation
        "response_scores": {},
        "multi_select": False,
    },
    "4.30": {
        "question": "What was the severity of your sleep apnea at the time of diagnosis?",
        "pillar_weights": {},  # Used in complex calculation
        "response_scores": {},
        "multi_select": False,
    },
    "4.31": {
        "question": "Which of the following treatments are you currently using for your sleep apnea? (select all that apply)",
        "pillar_weights": {},  # Used in complex calculation
        "response_scores": {},
        "multi_select": True,
    },
    "4.32": {
        "question": "How much has your current sleep apnea treatment improved your symptoms?",
        "pillar_weights": {},  # Used in complex calculation
        "response_scores": {},
        "multi_select": False,
    },
    "4.33": {
        "question": "Which of the following sleep apnea treatments would you be willing to try? (select all that apply)",
        "pillar_weights": {},  # Informational only
        "response_scores": {},
        "multi_select": True,
    },
    ...
    "6.07": {
        ...
        "score_fn": lambda ans, _, __, row=None: coping_score(
            ans, row.get("6.01", "") if row else "", row.get("6.02", "") if row else ""),
        "multi_select": True,
    },
    "6.08": {
