-- Fix unassigned aggregation to handle NULL event_instance_id
-- When event_instance_id is NULL, fall back to matching by entry_timestamp
    ...
    WHEN 'AVG' THEN
      IF p_filter_conditions IS NOT NULL THEN
        IF v_no_match THEN
          ...
          -- Handle both event_instance_id and entry_timestamp matching
          EXECUTE format('
...
SELECT '✅ Updated calculate_field_aggregation to handle NULL event_instance_id' as status;
