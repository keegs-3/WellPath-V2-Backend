...
-- NOTE: For child metrics, parent_metric_id must be NULL
...
Aggregations Linked:
  - AGG_DEEP_SLEEP_DURATION (child)
  - AGG_CORE_SLEEP_DURATION (child)
  - AGG_REM_SLEEP_DURATION (child)
  - AGG_TOTAL_SLEEP_DURATION (parent)
